...
The project includes automated tests for the menu, cart, promo, checkout, and order flow.
...
The validation phase follows the testing pyramid idea:
...
* Playwright E2E test for customer journey

---

## Gherkin Scenarios

The design specification includes Gherkin scenarios for:
...
* Order tracking
* Menu management
* Edge cases such as invalid promo codes, price tampering, and unavailable items
...
The project includes the following software engineering deliverables:
...
The system was validated through automated and manual evidence.
...
The project was divided into vertical slices:
